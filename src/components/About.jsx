const About = () => {
  return (
    <section id='about' className='max-w-4xl py-16 px-4 mx-6 md:mx-auto pt-[90px]'>
      <div className='md:mx-auto rounded-2xl border border-gray-100 bg-white shadow-md p-8 md:p-16 md:mt-16'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <div className='flex justify-center mt-8'>
            <a href='https://www.linkedin.com/in/navya-h-rao/' target='_blank' title="linkedin" rel='noopener noreferrer' className='mr-8 w-[50px] p-2 bg-white'>
              <div className='icon icon-linkedin cursor-pointer'></div>
            </a>
            <a href='https://github.com/navyahrao' target='_blank' rel='noopener noreferrer' title="github" className='mr-8 w-[50px] p-2  bg-white'>
              <div className='icon icon-githubLink cursor-pointer'></div>
            </a>
            <a href='mailto:navya.rao28@gmail.com' target='_blank' title="email" className='w-[50px] p-2 bg-white'>
