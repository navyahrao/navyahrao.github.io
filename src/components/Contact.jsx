...
const Contact = () => {
  ...
  return (
    <section id='contact' className='max-w-4xl py-16 px-4 mx-6 md:mx-auto pt-[90px]'>
      <div className='md:mx-auto rounded-2xl border border-gray-100 bg-white shadow-md p-8 md:p-16 md:mt-16'>
        ...
        <h2 className='text-3xl font-semibold text-violet-500'>Contact Me</h2>
          <p className='mt-4 md:text-lg text-gray-700'>Feel free to reach out if you want to collaborate or have any questions!</p>
          ...
          <div>
            ...
            <button type='submit' className="bg-violet-500 hover:bg-violet-600 hover:shadow-lg text-white py-2 px-6 rounded-lg cursor-pointer focus:outline-violet-600">Send Message</button>
          </form>
