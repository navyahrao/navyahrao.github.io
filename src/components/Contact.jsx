        ...
        <h2 className='text-3xl font-semibold text-violet-500'>Contact Me</h2>
          ...
          <form className='mt-8' onSubmit={handleSubmit}>
            <div>
              <input
                ...
                className='px-4 py-2 rounded-lg border border-gray-300 w-full md:w-2/3 mb-4'
          ...
          <div>
              <textarea
                ...
                className='px-4 py-2 rounded-lg border border-gray-300  w-full md:w-2/3 mb-4 min-h-32'
